...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getAllUserDetails = function () {
        return this._http.get("https://my-regdb-zuul-service-dev.apps.eas.pcf.manulife.com/producer/getAllUserDetails", this.options);
    };
    ...
    UserService.prototype.SaveUserDetails = function (user) {
        return this._http.post("https://my-regdb-zuul-service-dev.apps.eas.pcf.manulife.com/producer/SaveUserDetails", JSON.stringify(user), this.options);
    };
    UserService.prototype.updateUserDetails = function (user) {
        return this._http.put("https://my-regdb-zuul-service-dev.apps.eas.pcf.manulife.com/producer/updateUserDetails?empCode=" + user.empCode, JSON.stringify(user), this.options);
    };
